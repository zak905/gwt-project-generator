...
import com.gwidgets.gwtprojectgenerator.InitializrException
...
class ProjectGenerator {
	...
	protected File doGenerateProjectStructure(ProjectRequest request) {
		...
		write(new File(webapp, moduleName+".html"), "template.html", model)
		write(new File(webapp, moduleName+".css"), "template.css", model)
